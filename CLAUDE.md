...
Every run emits a **run manifest**: kernel version, resolved pack versions, manifest hash, Bronze partition ids and content hashes, **audit segment ids and content hashes**, reference snapshot ids, arming record, and the ordered list of applied transforms.
